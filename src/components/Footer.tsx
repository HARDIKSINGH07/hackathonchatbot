...
const Footer: React.FC = () => {
  return (
    <footer className="bg-white py-4 px-4 border-t border-gray-100">
      <div className="container mx-auto">
        ...
        <div className="mt-3 pt-2 border-t border-gray-200 flex flex-col md:flex-row justify-between items-center text-xs">
          <p className="text-gray-600 mb-1 md:mb-0">
