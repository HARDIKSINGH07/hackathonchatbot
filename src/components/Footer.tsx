...
export default function Footer() {
  return (
    <footer className="bg-gradient-to-r from-cyan-dark to-lavender-dark text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#resources" className="text-white/70 hover:text-white">Resources</a></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#" className="text-white/70 hover:text-white">Mental Health Articles</a></li>
              <li><a href="#" className="text-white/70 hover:text-white">Self-Care Techniques</a></li>
              <li><a href="#" className="text-white/70 hover:text-white">Crisis Support</a></li>
              <li><a href="#" className="text-white/70 hover:text-white">Find a Therapist</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-2">
              <input 
                ...
                className="bg-white/10 text-white rounded-full px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-white/30"
              />
